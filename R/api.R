...
#'   \item{add_legacy_pop_suffix}{For backwards compatibility reasons, there
#'   is a "Z" suffix in most of the \code{_pop/unwpop} columns. This option
#'   adds the "Z" to the column name.}
#' }
